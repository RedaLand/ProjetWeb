...
<?php require_once('pagesCommunes/header.php'); ?>
  ...
  <form id="formulaireGetPatient" action="SupprimerDossier.php" method="post">
    <h1 class="text-center">Supprimer le patient No:</h1>
    <div class="form col-md-6 col-md-offset-3">
        ...
        <span><br></br></span>
        <button class="btn btn-primary btn-lg btn-block" type="submit" name='submit' value='Submit'>Supprimer le patient</button>
        <span class="pull-right"><a href="http://followup.olympe.in/ListeMedecin.php">Liste des medecins</a></span><span><a href="#">Need help?</a></span>
    </div>
  </form>
